...
public class AllInOneActivity extends AbstractCalendarActivity implements EventHandler,
    ...
    public void setupFloatingActionButton() {
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // All new-event creation funnels through CalendarController
                // .launchCreateEvent, which shows the HABIT chooser when enabled.
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (itemId == R.id.timeline_menu_item) {
