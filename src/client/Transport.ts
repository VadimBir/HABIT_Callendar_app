...
// --- Stream A: autopilot ---
export class ToggleAutopilotEvent implements GameEvent {
  constructor(public readonly enabled: boolean) {}
}
// --- end Stream A: autopilot ---

// --- Stream B: troop ratio sliders ---
export class SetTroopRatioEvent implements GameEvent {
  constructor(
    public readonly growthR0: number,
    public readonly growthR1: number,
    public readonly targetR0: number,
    public readonly targetR1: number,
  ) {}
}
// --- end Stream B: troop ratio sliders ---
...
export class Transport {
  ...
  constructor(
    ...
    // --- Stream A: autopilot ---
    this.eventBus.on(ToggleAutopilotEvent, (e) => this.onToggleAutopilot(e));
    // --- Stream B: troop ratio sliders ---
  ...
  // --- Stream A: autopilot ---
  private onToggleAutopilot(event: ToggleAutopilotEvent) {
    this.sendIntent({
  ...
  private onSetTroopRatio(event: SetTroopRatioEvent) {
    this.sendIntent({
      ...
      growthR0: event.growthR0,
      growthR1: event.growthR1,
      targetR0: event.targetR0,
      targetR1: event.targetR1,
    });
  }
  // --- end Stream B: troop ratio sliders ---
