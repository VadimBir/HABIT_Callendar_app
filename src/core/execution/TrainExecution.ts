...
export class TrainExecution implements Execution {
  ...
  private _factoryStopsVisited: number = 0;
  // --- end Stream B ---
  ...
  // --- Stream B: factory/train/port income ---
  public factoryStopsVisited(): number {
    return this._factoryStopsVisited;
  }
  // --- end Stream B ---
  ...
  private stationReached() {
    ...
    // --- Stream B: factory/train/port income ---
    if (stationType === UnitType.Factory) {
      this._factoryStopsVisited++;
    }
    // --- end Stream B ---
    return;
  }
