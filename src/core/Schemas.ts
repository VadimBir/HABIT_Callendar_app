...
>;
// --- Stream A: autopilot ---
export type ToggleAutopilotIntent = z.infer<
  typeof ToggleAutopilotIntentSchema
>;
...
// --- Stream B: 3 troop types ---
export const SetTroopRatioIntentSchema = z.object({
  type: z.literal("set_troop_ratio"),
  growthR0: z.number().min(0).max(1),
  growthR1: z.number().min(0).max(1),
  targetR0: z.number().min(0).max(1),
  targetR1: z.number().min(0).max(1),
});
// --- end Stream B ---
...
// --- Stream A: autopilot ---
export const ToggleAutopilotIntentSchema = z.object({
  type: z.literal("toggle_autopilot"),
  enabled: z.boolean(),
});
// --- end Stream A: autopilot ---
