...
export function diffPlayerUpdate(
  ...
  // troopsByType is per-tick stat churn (like troops/gold/tilesOwned) and
  // travels via the packed playerStats quad, NOT the object channel. See the
  // EXCEPTION note above and PlayerImpl.toUpdate.
  // --- end Stream B ---
